        ...
        <Grid item xs={12} md={3} lg={3} sm={3} marginTop={8} marginLeft={6}>
          ...
          <Grid container marginTop={2} position={'relative'}>
            ...
            >
              ...
              <Button onClick={() => videoModal("deposit")}>Deposit Posting Queue</Button>
              <Button onClick={() => videoModal('patient')}>Patient Posting Queue</Button>
              <Button onClick={() => videoModal('payment')}>Zero Payment Posting Queue</Button>
            </Popover>
          </Grid>
        </Grid>
