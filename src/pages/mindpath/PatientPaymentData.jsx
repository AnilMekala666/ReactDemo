...
function PatientPaymentData() {
    ...
    const tableColumns = useMemo(
      () => [
        { header: 'Payment ID', accessorKey: 'transaction_number' },
        { header: 'Transaction Number', accessorKey: 'account_name' },
        // { header: 'Payment ID', accessorKey: 'payment_type' },
        { header: 'Payment ID', accessorKey: 'payer' },
