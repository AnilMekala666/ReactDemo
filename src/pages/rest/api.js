...
export const CORRESPONDENCE_ENDPOINTS = {
  ...
  ADD_EOB_PATIENT_LEVEL_DATA:`${CORRESPONDENCE_BASE_URL}/addNewPatientLevelData`,
  ADD_EOB_PATIENT_LINE_LEVEL_DATA:`${CORRESPONDENCE_BASE_URL}/insertNewLineLevelData`,
}
