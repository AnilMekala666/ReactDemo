...
import ReusableExpandableTable from 'components/tableComponent/ExpandableTable';


const CustomExpandableTable = ({ data, datacolumns, expandedColumns }) => {
    ...
    return (
        <div style={{marginTop:'10px'}} >
            ...
            <ReusableExpandableTable data={data} columns={datacolumns} expandedColumns={expandedColumns} />
        :""}
