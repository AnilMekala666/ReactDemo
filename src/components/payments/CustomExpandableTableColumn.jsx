...
import ReusableExpandableTableColumn from 'components/tableComponent/ExpandableTableColumn';


const CustomExpandableTableColumn = ({ data, datacolumns, expandedColumns }) => {
    ...
    return (
        <div style={{marginTop:'10px'}} >
            ...
            <ReusableExpandableTableColumn data={data} columns={datacolumns} expandedColumns={expandedColumns} />
        :""}
...
export default CustomExpandableTableColumn